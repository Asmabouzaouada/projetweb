...
<body class="main-layout">
    ...
    <header>
        <div class="header">
            <div class="container-fluid">
                ...
                <li>
                                <li>
                                    <a class="nav-link" href="../Commande/AfficheListeCommandeFront.php">Mes
                                        Commandes</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="titlepage">
                        <div>
                            <h2>Add New Panier</h2>
                            <form method="post" action="" onsubmit="return validateForm()" id="panierForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <span id="prixError" class="error-message"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nom_produit" name="nom_produit" class="form-control"
                                        required>
                                    <span id="nomProduitError" class="error-message"></span>
                                </div>

                                <div class="form-group">
                                    <label for="description_produit">Description Produit:</label>
                                    <textarea name="description_produit" class="form-control" rows="4"
                                        required></textarea>
                                </div>

                                <button type="submit" class="btn btn-primary">Add Panier</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function validateForm() {
            ...
            var nomProduitInput = document.getElementById("nom_produit");
