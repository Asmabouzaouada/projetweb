...
<head>
  ...
  <style>
    .petite-image {
            width: 35px; /* Ajustez la largeur de l'image selon vos besoins */
            height: 35px; /* Ajustez la hauteur de l'image selon vos besoins */
            margin-right: 5px; /* Marge à droite du bouton pour espacement */
        }
   </style>
      <div class="header">
         ...
         <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <img src="img.jpg" alt="Image" class="petite-image">
                        <p>WELCOM <?php echo $user['pseudo']; ?></p>

    <p>Email: <?php echo $user['email']; ?></p>
    <p>Role: <?php echo $user['role']; ?></p>

    <!-- Add any additional content for the user dashboard -->
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">Welcome <br></span>To Our Shop</h1>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">Welcome <br></span>To Our Shop</h1>
                           <figure><img src="images/banner_img2.gif" alt="#"/></figure>
                           <a class="read_more" href="glasses.html">Shop Now</a>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">Welcome <br></span>To Our Shop</h1>
                           <figure><img src="images/banner_img3.gif" alt="#"/></figure>
                           <a class="read_more" href="glasses.html">Shop Now</a>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row d_flex">
               ...
               <div class="col-md-7">
                  <div class="titlepage">
                     ...
                     <p>Our mission is to make the world more colorful and vibrant for those affected by color blindness. 
                        We offer a thoughtfully curated selection of glasses designed to correct various types of color 
                        blindness, making high-quality products accessible to everyone. Whether you're looking for 
                        sunglasses, prescription glasses, or contact lenses, we have what you need to live a more 
                        colorful life. Book a consultation first !</p>
                  </div>
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass1.jpg" alt="#"/></figure>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass2.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 2</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass3.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 3</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass4.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 4</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass5.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 5</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass6.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 6</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass7.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 7</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="images/glass8.jpg" alt="#"/></figure>
                     <h3><span class="blu">$</span>50</h3>
                     <p>Modèle 8</p>
                  </div>
               </div>
               <div class="col-md-12">
                  <a class="read_more" href="glasses.html">Read More</a>
               </div>
            </div>
         </div>
      </div>
      ...
      <div id="about" class="shop">
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-5">
                  <div  class="shop_img">
                     <figure><img src="images/shop_img.jpg" alt="#"/></figure>
                  </div>
               </div>
                           ...
                           <div class="container">
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="clients_box">
                                          <figure><img src="images/our2.jpg" alt="#"/></figure>
                                          <h3>Manks Mark</h3>
